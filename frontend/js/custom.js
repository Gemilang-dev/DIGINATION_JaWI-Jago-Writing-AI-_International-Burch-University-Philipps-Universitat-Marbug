...
//                 Dashboard
//             </a>`;
//     } else { // Menu untuk User (Dengan Accordion)
//         menuLinksHtml = `
...
//               </div>
//               <div class="accordion-content overflow-hidden pl-4" style="display: none;">
//                 <a href="#history-task-1" role="button" class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-gray-100"><div class="grid mr-4 place-items-center">-</div>Task 1 History</a>
//                 <a href="#history-task-2" role="button" class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-gray-100"><div class="grid mr-4 place-items-center">-</div>Task 2 History</a>
//               </div>
//             </div>
//              <hr class="my-2 border-blue-gray-50" />
//              <a href="#" id="logout-btn-sidebar" role="button" class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-gray-100">
//                 <div class="grid mr-4 place-items-center"><svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M12 2.25a.75.75 0 01.75.75v9a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM6.166 5.106a.75.75 0 010 1.06 8.25 8.25 0 1011.668 0 .75.75 0 111.06-1.06c3.808 3.807 3.808 9.98 0 13.788-3.807 3.808-9.98 3.808-13.788 0-3.808-3.807-3.808-9.98 0-13.788a.75.75 0 011.06 0z" clip-rule="evenodd"></path></svg></div>
//                 Log Out
//             </a>
//         `;
//     }
...
//     app.route({ view: 'history-task-1', load: 'user/history_task_1.html' });
//     app.route({ view: 'history-task-2', load: 'user/history_task_2.html' });
...
//         // (Opsional) Tutup accordion lain saat yang satu dibuka
